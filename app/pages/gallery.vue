	...
	<div>
		...
		<div class="mx-16 my-16 mt-40 flex flex-col md:mx-14 lg:mx-20">
			<CombiFilter
				...
				class="mb-10"
			/>
            <button class="justify-end flex w-full flex-row items-center gap-2 text-xl cursor-pointer"
                    @click="toggleDetails"
            >
                <Icon
                    v-if="showDetails"
                ...
                <Icon
                    v-else
                    name="famicons:radio-button-off"
                    class=""
                />
                Details
            </button>

            <div class="grid-cols-5 grid gap-3" v-if="!showDetails">
				<div v-for="image in filteredImages">
					<ImgWrap :src="image.src" :alt="image.alt" :crop="!showDetails"/>
				</div>
			</div>
            <div class="grid-cols-1 grid gap-12" v-else>
				<div v-for="image in filteredImages">
					<ImgWrap :src="image.src" :alt="image.alt" :crop="!showDetails"/>
				</div>
			</div>
...
const images = [
	{
		...
		tags: ["seattle", "washington", "night", "water", "sound", "fairy", "color"],
	...
	},
	{
		...
		tags: ["seattle", "washington", "night", "water", "sound", "fairy", "desaturated", "color"],
		dates: [{ start: "2025-01-15", end: "2025-01-15" }],
	...
	},
	{
		...
		tags: ["dallas", "texas", "utd", "university", "chromatic abjuration", "reflection", "color"],
	...
	},
	{
		...
		tags: ["austin", "texas", "animal", "bird", "birds", "sky", "black and white", "black & white", "b&k"],
	...
	},
	{
		...
		tags: ["lorena", "texas", "gas", "gas station", "liminal", "night", "color"],
	...
	},
	{
		...
		tags: ["seattle", "washington", "people", "pike place", "pike place market", "market", "indoors", "night", "color"],
	...
	},
	{
		...
		tags: ["seattle", "washington", "people", "pike place", "pike place market", "market", "indoors", "night", "black and white", "black & white", "b&k"],
		dates: [{ start: "2025-01-09", end: "2025-01-09" }],
	...
	},
	{
		...
		tags: ["vancuver", "bc", "british columbia", "night", "color", "neon", "neon sign", "wet", "chinatown"],
