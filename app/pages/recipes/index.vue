	...
	let internal = [
		{
			...
			thumbnailAlt: "Brownie Ingredients Laid Out",
		...
		},
		{
			...
			thumbnailAlt: "Espresso Cup, with a spoon and Seltzer Water",
		...
		},
		{
			...
			thumbnailAlt:
				"Latte with Scale to the left and Milk Pitcher behind",
			name: "recipes-coffee-variant",
			variant: "latte",
		},
		{
			title: "Pour-Over",
			ingredients: ["coffee beans", "water"],
			equipment: ["grinder", "scale", "v60", "kettle"],
			dietary: ["caffeine"],
			tags: ["drink"],
			dates: [],
			thumbnail: "/images/recipes/coffee/pour-over-thumbnail.webp",
			thumbnailAlt: "Cup of pour-over coffee, with a spoon",
			name: "recipes-coffee-variant",
			variant: "pour-over",
		},
		{
			...
			thumbnailAlt: "Bowl of Pasta with Seltzer Water",
		...
		},
		{
			...
			thumbnailAlt: "Ingredients for Lemon-Limeade",
